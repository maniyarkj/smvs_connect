...
angular.module('smvsApp.services', []).
	service('$menuItems', function()
	{
		...
		{
			// var dashboard    = this.addItem('Dashboard', 		'/dashboard', 			'linecons-cog');
			// var layouts      = this.addItem('Layout & Skins',	'/layout-and-skins',	'linecons-desktop');
			// var ui_elements  = this.addItem('UI Elements', 		'/ui', 					'linecons-note');
			// var widgets  	 = this.addItem('Widgets', 			'/widgets', 			'linecons-star');
			// var mailbox  	 = this.addItem('Mailbox', 			'/mailbox', 			'linecons-mail').setLabel('5', 'secondary', false);
			// var tables  	 = this.addItem('Tables', 			'/tables', 				'linecons-database');
			var masterModule  	 	 = this.addItem('Master', 			'/master', 				'linecons-params');
			// var extra  	 	 = this.addItem('Extra', 			'/extra', 				'linecons-beaker').setLabel('New Items', 'purple');
			// var charts  	 = this.addItem('Charts', 			'/charts', 				'linecons-globe');
			// var menu_lvls  	 = this.addItem('Menu Levels', 		'', 						'linecons-cloud');
				...
				// dashboard.addItem('Update Hightlights', '/update-highlights').setLabel('v1.3', 'pink');
				...
				masterModule.addItem('Member Profile',		'-/member-profile');
				masterModule.addItem('Zone',	'/zone');
				masterModule.addItem('Center',	'/center');
				masterModule.addItem('Layout & Skins',	'/layout-and-skins');
				// adminModule.addItem('Advanced Plugins',		'-/advanced');
				// adminModule.addItem('Form Wizard',			'-/wizard');
				// adminModule.addItem('Form Validation',		'-/validation');
				// adminModule.addItem('Input Masks',			'-/input-masks');
				// adminModule.addItem('File Upload',			'-/file-upload');
				// adminModule.addItem('Editors',				'-/wysiwyg');
				// adminModule.addItem('Sliders',				'-/sliders');
		...
		{
			// var dashboard    = this.addItem('Dashboard', 		'/dashboard', 			'linecons-cog');
			// var layouts      = this.addItem('Layout',			'/layout-and-skins',	'linecons-desktop');
			// var ui_elements  = this.addItem('UI Elements', 		'/ui', 					'linecons-note');
			var adminModule  	 	 = this.addItem('Forms', 			'/adminModule', 				'linecons-params');
			// var other  	 	 = this.addItem('Other', 			'/extra', 				'linecons-beaker');
				...
				// Subitems of Others
				// var widgets     = other.addItem('Widgets', 			'/widgets', 			'linecons-star');
				// var mailbox     = other.addItem('Mailbox', 			'/mailbox', 			'linecons-mail').setLabel('5', 'secondary', false);
				// var tables      = other.addItem('Tables', 			'/tables', 				'linecons-database');
				// var extra       = other.addItem('Extra', 			'/extra', 				'linecons-beaker').setLabel('New Items', 'purple');
				// var charts      = other.addItem('Charts', 			'/charts', 				'linecons-globe');
